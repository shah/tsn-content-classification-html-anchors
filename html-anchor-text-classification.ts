...
export interface AnchorTextClassificationRule<C> extends cc.ContentClassificationRule<string, C> {
    ...
    readonly periodicalName: cc.FlexMatch;
...
export function sideEffectRule(match: cc.FlexMatch, options?: RuleOptions): AnchorTextClassificationRule<typeof SideEffectRuleCode> {
    const rule = {
        match: match,
        periodicalName: options?.periodicalName || cc.matchAny(),
...
export function contentRule(match: cc.FlexMatch, options?: RuleOptions): AnchorTextClassificationRule<typeof ContentRuleCode> {
    const rule = {
...
export function nonContentRule(match: cc.FlexMatch, options?: RuleOptions): AnchorTextClassificationRule<typeof NonContentRuleCode> {
    const rule = {
        ID: (): string => { return classificationRuleID(rule, SideEffectRuleCode) },
        match: match,
        periodicalName: options?.periodicalName || cc.matchAny(),
